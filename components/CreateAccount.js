  ...
  onImageUpload = async () => {
    ...
    try {
      ...
      if (cameraRollPerm === 'granted') {
        ...
        let uploadUrl = await FirebaseService.uploadImage(resizedUri);
        //let uploadUrl = await FirebaseService.uploadImageAsync(resizedUri);
        ...
        await FirebaseService.updateAvatar(uploadUrl); //might failed
      }
    } catch (err) {
